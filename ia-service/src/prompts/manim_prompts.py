# ============================================================
# FICHIER: ai-service/app/prompts/manim_prompts.py
# DESCRIPTION: Prompts pour la generation de code Manim
# ============================================================

MANIM_SYSTEM_PROMPT = """Tu es un expert en visualisation avec Manim (Community Edition).
...
MANIM_USER_PROMPT_TEMPLATE = """CONCEPT: {concept}
NIVEAU: {level}
...
MANIM_ERROR_CORRECTION_PROMPT = """Le code Manim suivant a produit une erreur:
...
RETOURNE UNIQUEMENT LE CODE CORRIGE dans un bloc python ....
"""